                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 p-8 lg:p-12">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="flex gap-4">
                                <button className="flex-1 bg-gray-900 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-800 transition-all transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                                    Add to Cart
                                </button>
                                <button className="px-4 py-4 rounded-xl border-2 border-gray-200 hover:border-gray-900 transition-colors">
