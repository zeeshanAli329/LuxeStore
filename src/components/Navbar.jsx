...
export default function Navbar() {
    ...
    // Calculate total items (handling both backend populated cart and potentially local structure if any, though we switched to backend)
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <Link
                            href="/"
                            className="text-2xl font-bold text-gray-900 tracking-tight  transition-opacity"
                        >
                        ...
                        <div className="relative group">
                            <div className="relative">
                                <input
                                    ...
                                    onFocus={() =>
                                        searchQuery.length > 0 && setIsSearchOpen(true)
                                    }
                            ...
                            {isSearchOpen && (
                                <div className="absolute top-full mt-2 w-full bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                                    <div className="p-3">
                                        ...
                                        <ul>
                                            {["Men's Jacket", "Leather Bag", "Smart Watch"].map(
                                                (item, idx) => (
                                                    <li key={idx}>
                                                        <Link
                                                            href="/shop"
