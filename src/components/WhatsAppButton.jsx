...
export default function WhatsAppButton() {
    ...
    const phoneNumber = "923279430520"; // Updated number as requested
    ...
    return (
        ...
        >
            ...
            <span className="absolute right-full mr-3 bg-white text-gray-800 px-3 py-1 rounded-lg shadow-lg text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                Chat with us
            </span>
        </a>
    );
