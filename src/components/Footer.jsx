...
import { COMPANY_NAME, FT_LOGO, ALT } from "@/app/constants/names";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 flex flex-col md:flex-row space-between">
                    ...
                    <div>
                        {/* <Link href="/" className=" mb-10 ">
                            <img className="h-15 bg-white mb-10" src={FT_LOGO} alt={ALT}></img>
                        </Link> */}
                        ...
                        <div className="flex space-x-4">
                            {/* Social Icons */}
                            <Link href="https://www.facebook.com/DormexStore" className="text-gray-400 hover:text-white transition-colors">
